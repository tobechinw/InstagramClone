...
const Tweets = ( { navigation, route } ) => {
  return (
    <Screen style={{  flex: 1, justifyContent: 'center', alignItems: 'center' }}>
      ...
      <AppButton title={"Tweet Detail"} onPress={ () => navigation.navigate("TweetDetails", { tweetNumber: 1 } )} />
    </Screen>
  )
}
...
const TweetDetails = ( { navigation, route } ) => (
  <Screen style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
    ...
    <AppButton title={"Back"} onPress={() => navigation.navigate("Tweets", {id: 50}) } />
  </Screen>
)
  ...
  >
    ...
    <Stack.Screen 
      ...
      options={({ navigation }) => ({
        ...
        headerLeft: () => <Button title='Left' onPress={() => navigation.goBack() } />,
      })}
    />
  </Stack.Navigator>
)
...
const TabNavigator = () => (
  ...
  >
    ...
    />
    <Tab.Screen name='Account' component={StackNavigator} initialParams={{ id: 50 }} />
  </Tab.Navigator>
)
